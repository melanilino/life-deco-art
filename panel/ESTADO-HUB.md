...
- Las categorías relacionadas se separan 16 px de la línea del encabezado y no usan línea inferior. La opción activa tiene un fondo marrón suave, texto marrón de mayor peso, sin borde y menor altura; las demás quedan como texto marrón sin fondo.
