...
- Ventas reúne Cotizaciones y Facturas mediante dos pestañas propias del proceso comercial. Cada vista usa indicadores y estados específicos, filtros por fecha y orden, exportación dentro del menú secundario y vacíos con una acción útil. Crear ofrece cotización o factura directa; las cotizaciones se editan a pantalla completa y, al aceptarse, pueden generar pedido y factura reutilizando sus datos. Los pagos de facturas siguen alimentando los mismos registros usados por Finanzas e Inicio.
