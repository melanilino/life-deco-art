...
- Exportar CSV aparece únicamente en el pie de las tablas, alineado con la paginación cuando exista. Al enfocar campos y botones se utiliza su propio borde, sin añadir un segundo aro exterior.
