...
- La página Clientes reutiliza esas reglas: métricas en superficies blancas, filtros con un único borde estándar y tabla sin estilos ajenos al HUB. Crear → Nuevo cliente abre un panel lateral sobre la lista, con formularios adaptados a Persona o Empresa, más información desplegable, aviso de coincidencias y acciones inferiores neutras. Guardar actualiza la lista y sus métricas; Guardar y crear pedido abre el pedido con el cliente ya seleccionado.
- La navegación lateral y la línea de cierre de la cabecera comparten una altura constante en todas las secciones. Notas y cada formulario abierto desde Crear usan el mismo ancho de panel lateral y una cabecera alineada; sus contenidos se organizan en superficies blancas sobre crema. Crear muestra solo opciones propias de la sección activa (en Inicio ofrece accesos rápidos a varias secciones). Los selectores de Clientes reservan espacio interior para la flecha.
- Las categorías de creación se muestran únicamente dentro del menú Crear de la sección correspondiente. No se repiten como pestañas sobre las listas.
- Ventas alterna Cotizaciones y Facturas mediante el selector compacto «Vista actual», alineado con el botón neutro de Notas. Cada vista muestra indicadores, estados, fechas y columnas propios; Exportar CSV y el botón de creación se encuentran juntos dentro de la barra de resultados. Los formularios de cotización y factura ocupan la pantalla de trabajo, separan la información general, las partidas y las condiciones, y mantienen un resumen de importes a la derecha. Las cotizaciones aceptadas pueden generar pedido y factura reutilizando sus datos; los pagos siguen alimentando los mismos registros usados por Finanzas e Inicio.
- Las líneas de navegación, cabecera principal y paneles laterales coinciden a 100 px del borde superior, sin dejar espacio excesivo bajo los títulos. Los paneles de Notas y Crear comparten un ancho de 500 px en escritorio y ocupan la pantalla disponible en móvil. El menú Crear nombra solo el tipo de registro (Cliente, Cotización, Cálculo, Actividad, etc.); el formulario puede conservar un título descriptivo como «Nuevo cliente». La flecha de «Vincular con» en Notas mantiene la misma separación interior que los filtros de Clientes.
