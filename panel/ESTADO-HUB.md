...
- La cabecera muestra «Vista actual» en lugar de «Crear». Cuando una sección tiene subcategorías, el selector permite cambiar entre ellas sin repetir pestañas; cuando tiene una sola vista, se muestra su nombre sin flecha. Las acciones para registrar elementos nuevos viven en la barra operativa de cada lista.
