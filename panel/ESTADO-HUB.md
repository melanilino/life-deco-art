...
- Ventas alterna Cotizaciones y Facturas mediante el selector «Vista actual», sin repetirlas como pestañas. Cada vista muestra indicadores, estados, fechas y columnas propios; el botón de creación se encuentra dentro de su bloque de resultados. Los formularios de cotización y factura ocupan la pantalla de trabajo, separan la información general, las partidas y las condiciones, y mantienen un resumen de importes a la derecha. Las cotizaciones aceptadas pueden generar pedido y factura reutilizando sus datos; los pagos siguen alimentando los mismos registros usados por Finanzas e Inicio.
