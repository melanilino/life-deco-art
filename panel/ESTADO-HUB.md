...
- El primer bloque o control visible de cada sección comienza a 28 px bajo el encabezado en escritorio (24 px en móvil). En secciones con pestañas, la fila de pestañas ocupa ese primer nivel y el contenido queda debajo; Clientes e Inicio comienzan sus tarjetas en el mismo nivel. Los indicadores de Servicios no añaden un margen superior adicional.
- Las cuatro métricas de Clientes reservan dos líneas para el título y dos para la explicación, de modo que títulos, cifras y textos comiencen a la misma altura. «Con saldo / pendiente» y «Nuevos / este mes» usan un salto controlado. La cuadrícula usa cuatro columnas solo cuando hay ancho suficiente; pasa a dos y luego a una columna antes de que los textos se compriman o se corten.
