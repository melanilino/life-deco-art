...
- Ventas reúne cotizaciones y facturas en una sola lista, identificadas por tipo y estado. No repite estas categorías como pestañas: se crean únicamente desde el menú Crear, con las opciones «Cotización» y «Factura». La vista conserva filtros por estado, fecha y orden; la exportación vive dentro del menú secundario. Las cotizaciones se editan a pantalla completa y, al aceptarse, pueden generar pedido y factura reutilizando sus datos. Los pagos de facturas siguen alimentando los mismos registros usados por Finanzas e Inicio.
