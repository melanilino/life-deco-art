...
- La página Clientes reutiliza esas reglas: métricas en superficies blancas, filtros con un único borde estándar y tabla sin estilos ajenos al HUB. «Nuevo cliente» abre una página completa dentro del HUB, con el mismo patrón amplio de cotizaciones y facturas: datos principales en una tarjeta, un resumen lateral de lo que ocurrirá al guardar y toda la información adicional visible dentro de una sola tarjeta blanca, sin desplegable ni subdivisiones. Conserva los formularios adaptados a Persona o Empresa, el aviso de coincidencias y las acciones inferiores neutras. Guardar actualiza la lista y sus métricas; Guardar y crear pedido abre el pedido con el cliente ya seleccionado.
